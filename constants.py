...
CHANNEL_DESCRIPTION_LOOKUP = {
    ...
    "km": "Khan Academy ផ្តល់ជូននូវវីដេអូនិងលំហាត់គណិតវិទ្យា។ មុខវិជ្ជាទាំងអស់ត្រូវបានពន្យល់តាមរយៈវីដេអូដែលមានវិចារណញាណហើយមានលំហាត់ជាច្រើនដើម្បីជួយសិស្សឱ្យចេះស្ទាត់ជំនាញលើគំនិត។",  # via google transalte
    "gu": "ખાન એકેડેમી ગણિત અને વિજ્ .ાનમાં વિડિઓઝ અને કસરતો પ્રદાન કરે છે. દરેક વિષય સાહજિક વિડિઓઝ દ્વારા આવરી લેવામાં આવે છે અને તેમાં વિદ્યાર્થીઓને મુખ્ય ખ્યાલોમાં સહાય કરવા માટે અસંખ્ય કસરતો શામેલ છે.",  # via google transalte
